...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 304,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 305,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 306,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 307,                       /* -Wprotocol */
  OPT_Wpsabi = 308,                          /* -Wpsabi */
  OPT_Wraw = 309,                            /* -Wraw */
  OPT_Wreal_q_constant = 310,                /* -Wreal-q-constant */
  OPT_Wredundant_decls = 311,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 312,            /* -Wredundant-modifiers */
  OPT_Wreorder = 313,                        /* -Wreorder */
  OPT_Wreturn_type = 314,                    /* -Wreturn-type */
  OPT_Wselector = 315,                       /* -Wselector */
  OPT_Wsequence_point = 316,                 /* -Wsequence-point */
  OPT_Wserial = 317,                         /* -Wserial */
  OPT_Wshadow = 318,                         /* -Wshadow */
  ...
  OPT_Wstack_usage_ = 324,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 325,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 326,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 327,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 328,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 329,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 330,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 331,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 332,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 333,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 334,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 335,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 336,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 337,                       /* -Wsuppress */
  OPT_Wsurprising = 338,                     /* -Wsurprising */
  OPT_Wswitch = 339,                         /* -Wswitch */
  OPT_Wswitch_default = 340,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 341,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 342,                      /* -Wsync-nand */
  OPT_Wsynth = 343,                          /* -Wsynth */
  OPT_Wsynthetic_access = 344,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 345,                 /* -Wsystem-headers */
  OPT_Wtabs = 346,                           /* -Wtabs */
  OPT_Wtasks = 347,                          /* -Wtasks */
  OPT_Wtraditional = 348,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 349,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 350,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 351,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 352,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 353,                    /* -Wtype-limits */
  OPT_Wuncheck = 354,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 355,            /* -Wundeclared-selector */
  OPT_Wundef = 356,                          /* -Wundef */
  OPT_Wunderflow = 357,                      /* -Wunderflow */
  OPT_Wuninitialized = 358,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 359,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 360,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 361,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 362, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 363,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 364,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 365,                         /* -Wunused */
  OPT_Wunused_argument = 366,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 367,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 368,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 369,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 370,                /* -Wunused-function */
  OPT_Wunused_import = 371,                  /* -Wunused-import */
  OPT_Wunused_label = 372,                   /* -Wunused-label */
  OPT_Wunused_local = 373,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 374,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 375,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 376,               /* -Wunused-parameter */
  OPT_Wunused_private = 377,                 /* -Wunused-private */
  OPT_Wunused_result = 378,                  /* -Wunused-result */
  OPT_Wunused_thrown = 379,                  /* -Wunused-thrown */
  OPT_Wunused_value = 380,                   /* -Wunused-value */
  OPT_Wunused_variable = 381,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 382,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 383,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 384,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 385,   /* -Wvector-operation-performance */
  OPT_Wvla = 386,                            /* -Wvla */
  OPT_Wvolatile_register_var = 387,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 388,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 389,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 390,  /* -Wzero-as-null-pointer-constant */
  OPT_Xassembler = 391,                      /* -Xassembler */
  OPT_Xlinker = 392,                         /* -Xlinker */
  OPT_Xpreprocessor = 393,                   /* -Xpreprocessor */
  OPT_Z = 394,                               /* -Z */
  OPT_ansi = 395,                            /* -ansi */
  OPT_aux_info = 396,                        /* -aux-info */
  /* OPT_aux_info_ = 397, */                 /* -aux-info= */
  OPT_auxbase = 398,                         /* -auxbase */
  OPT_auxbase_strip = 399,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 400, */             /* -bootclasspath */
  OPT_c = 401,                               /* -c */
  /* OPT_classpath = 402, */                 /* -classpath */
  OPT_coverage = 403,                        /* -coverage */
  OPT_cpp = 404,                             /* -cpp */
  OPT_cpp_ = 405,                            /* -cpp= */
  OPT_d = 406,                               /* -d */
  OPT_dumpbase = 407,                        /* -dumpbase */
  OPT_dumpdir = 408,                         /* -dumpdir */
  OPT_dumpmachine = 409,                     /* -dumpmachine */
  OPT_dumpspecs = 410,                       /* -dumpspecs */
  OPT_dumpversion = 411,                     /* -dumpversion */
  OPT_e = 412,                               /* -e */
  /* OPT_encoding = 413, */                  /* -encoding */
  OPT_export_dynamic = 414,                  /* -export-dynamic */
  OPT_extdirs = 415,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 416, */               /* -fCLASSPATH= */
  OPT_fPIC = 417,                            /* -fPIC */
  OPT_fPIE = 418,                            /* -fPIE */
  OPT_fRTS_ = 419,                           /* -fRTS= */
  OPT_fabi_version_ = 420,                   /* -fabi-version= */
  OPT_faccess_control = 421,                 /* -faccess-control */
  OPT_faggressive_function_elimination = 422,/* -faggressive-function-elimination */
  OPT_falign_commons = 423,                  /* -falign-commons */
  OPT_falign_functions = 424,                /* -falign-functions */
  OPT_falign_functions_ = 425,               /* -falign-functions= */
  OPT_falign_jumps = 426,                    /* -falign-jumps */
  OPT_falign_jumps_ = 427,                   /* -falign-jumps= */
  OPT_falign_labels = 428,                   /* -falign-labels */
  OPT_falign_labels_ = 429,                  /* -falign-labels= */
  OPT_falign_loops = 430,                    /* -falign-loops */
  OPT_falign_loops_ = 431,                   /* -falign-loops= */
  OPT_fall_intrinsics = 432,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 433, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 434,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 435,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 436, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 437, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 438, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 439, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 440, */  /* -fargument-noalias-global */
  OPT_fasm = 441,                            /* -fasm */
  OPT_fassert = 442,                         /* -fassert */
  OPT_fassociative_math = 443,               /* -fassociative-math */
  OPT_fassume_compiled = 444,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 445,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 446,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 447,                   /* -fauto-inc-dec */
  OPT_fautomatic = 448,                      /* -fautomatic */
  OPT_faux_classpath = 449,                  /* -faux-classpath */
  OPT_fbackslash = 450,                      /* -fbackslash */
  OPT_fbacktrace = 451,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 452,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 453,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 454,              /* -fbootstrap-classes */
  OPT_fbounds_check = 455,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 456,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 457,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 458,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 459,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 460,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 461,                /* -fbuilding-libgcc */
  ...
  OPT_fcheck_array_temporaries = 467,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 468,                /* -fcheck-data-deps */
  OPT_fcheck_new = 469,                      /* -fcheck-new */
  OPT_fcheck_references = 470,               /* -fcheck-references */
  OPT_fcheck_ = 471,                         /* -fcheck= */
  OPT_fclasspath_ = 472,                     /* -fclasspath= */
  OPT_fcoarray_ = 473,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 474,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 475,                         /* -fcommon */
  OPT_fcompare_debug = 476,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 477,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 478,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 479,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 480,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 481,                  /* -fcond-mismatch */
  OPT_fconserve_space = 482,                 /* -fconserve-space */
  OPT_fconserve_stack = 483,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 484,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 485,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 486,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 487,          /* -fconvert=little-endian */
  OPT_fconvert_native = 488,                 /* -fconvert=native */
  OPT_fconvert_swap = 489,                   /* -fconvert=swap */
  OPT_fcprop_registers = 490,                /* -fcprop-registers */
  OPT_fcray_pointer = 491,                   /* -fcray-pointer */
  OPT_fcrossjumping = 492,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 493,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 494, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 495,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 496,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 497,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 498,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 499,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 500,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 501,                       /* -fdbg-cnt= */
  OPT_fdce = 502,                            /* -fdce */
  OPT_fdebug_cpp = 503,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 504,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 505,            /* -fdebug-types-section */
  ...
  OPT_fextension_elimination = 561,          /* -fextension-elimination */
  OPT_fexternal_blas = 562,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 563, */       /* -fexternal-templates */
  OPT_ff2c = 564,                            /* -ff2c */
  OPT_ffast_math = 565,                      /* -ffast-math */
  OPT_ffat_lto_objects = 566,                /* -ffat-lto-objects */
  OPT_ffeature_proxy = 567,                  /* -ffeature-proxy */
  ...
  OPT_ffrontend_optimize = 586,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 587,                   /* -ffunction-cse */
  OPT_ffunction_sections = 588,              /* -ffunction-sections */
  OPT_fgcse = 589,                           /* -fgcse */
  OPT_fgcse_after_reload = 590,              /* -fgcse-after-reload */
  OPT_fgcse_las = 591,                       /* -fgcse-las */
  OPT_fgcse_lm = 592,                        /* -fgcse-lm */
  OPT_fgcse_sm = 593,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 594,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 595,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 596,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 597,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 598,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 599,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 600,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 601,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 602,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 603,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 604,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 605,                       /* -fgraphite */
  OPT_fgraphite_identity = 606,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 607,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 608, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 609, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 610,           /* -fhash-synchronization */
  /* OPT_fhelp = 611, */                     /* -fhelp */
  /* OPT_fhelp_ = 612, */                    /* -fhelp= */
  /* OPT_fhonor_std = 613, */                /* -fhonor-std */
  OPT_fhosted = 614,                         /* -fhosted */
  /* OPT_fhuge_objects = 615, */             /* -fhuge-objects */
  OPT_fident = 616,                          /* -fident */
  OPT_fif_conversion = 617,                  /* -fif-conversion */
  OPT_fif_conversion2 = 618,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 619,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 620,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 621,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 622,             /* -fimplicit-templates */
  OPT_findirect_classes = 623,               /* -findirect-classes */
  OPT_findirect_dispatch = 624,              /* -findirect-dispatch */
  OPT_findirect_inlining = 625,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 626,         /* -finhibit-size-directive */
  OPT_finit_character_ = 627,                /* -finit-character= */
  OPT_finit_integer_ = 628,                  /* -finit-integer= */
  OPT_finit_local_zero = 629,                /* -finit-local-zero */
  OPT_finit_logical_ = 630,                  /* -finit-logical= */
  OPT_finit_real_ = 631,                     /* -finit-real= */
  OPT_finline = 632,                         /* -finline */
  OPT_finline_atomics = 633,                 /* -finline-atomics */
  OPT_finline_functions = 634,               /* -finline-functions */
  OPT_finline_functions_called_once = 635,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 636, */            /* -finline-limit- */
  OPT_finline_limit_ = 637,                  /* -finline-limit= */
  OPT_finline_small_functions = 638,         /* -finline-small-functions */
  OPT_finput_charset_ = 639,                 /* -finput-charset= */
  OPT_finstrument_function_calls = 640,      /* -finstrument-function-calls */
  OPT_finstrument_functions = 641,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 642,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 643,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 644,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 645,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 646,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 647,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 648,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 649,                    /* -fipa-profile */
  OPT_fipa_pta = 650,                        /* -fipa-pta */
  OPT_fipa_pure_const = 651,                 /* -fipa-pure-const */
  OPT_fipa_reference = 652,                  /* -fipa-reference */
  OPT_fipa_sra = 653,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 654, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 655,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 656,              /* -fira-loop-pressure */
  OPT_fira_region_ = 657,                    /* -fira-region= */
  OPT_fira_share_save_slots = 658,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 659,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 660,                   /* -fira-verbose= */
  OPT_fivopts = 661,                         /* -fivopts */
  OPT_fjni = 662,                            /* -fjni */
  OPT_fjump_tables = 663,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 664,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 665,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 666,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 667, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 668,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 669,             /* -fleading-underscore */
  OPT_flicense_me = 670,                     /* -flicense-me */
  OPT_floop_block = 671,                     /* -floop-block */
  OPT_floop_flatten = 672,                   /* -floop-flatten */
  OPT_floop_interchange = 673,               /* -floop-interchange */
  /* OPT_floop_optimize = 674, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 675,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 676,                /* -floop-strip-mine */
  OPT_flto = 677,                            /* -flto */
  OPT_flto_compression_level_ = 678,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 679,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 680,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 681,             /* -flto-partition=none */
  OPT_flto_report = 682,                     /* -flto-report */
  OPT_flto_ = 683,                           /* -flto= */
  OPT_fltrans = 684,                         /* -fltrans */
  OPT_fltrans_output_list_ = 685,            /* -fltrans-output-list= */
  OPT_fmain_ = 686,                          /* -fmain= */
  OPT_fmath_errno = 687,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 688,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 689,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 690,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 691,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 692,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 693,                     /* -fmem-report */
  OPT_fmerge_all_constants = 694,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 695,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 696,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 697,                /* -fmessage-length= */
  OPT_fmodule_private = 698,                 /* -fmodule-private */
  OPT_fmodulo_sched = 699,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 700,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 701,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 702,                  /* -fms-extensions */
  OPT_fmudflap = 703,                        /* -fmudflap */
  OPT_fmudflapir = 704,                      /* -fmudflapir */
  OPT_fmudflapth = 705,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 706, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 707, */                  /* -fnew-abi */
  OPT_fnext_runtime = 708,                   /* -fnext-runtime */
  OPT_fnil_receivers = 709,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 710,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 711,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 712, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 713,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 714,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 715,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 716,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 717,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 718,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 719,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 720,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 721,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 722,             /* -fomit-frame-pointer */
  OPT_fopenmp = 723,                         /* -fopenmp */
  OPT_foperator_names = 724,                 /* -foperator-names */
  OPT_foptimize_register_move = 725,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 726,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 727,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 728,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 729, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 730,              /* -foutput-class-dir= */
  OPT_fpack_derived = 731,                   /* -fpack-derived */
  OPT_fpack_struct = 732,                    /* -fpack-struct */
  OPT_fpack_struct_ = 733,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 734,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 735,              /* -fpcc-struct-return */
  OPT_fpch_deps = 736,                       /* -fpch-deps */
  OPT_fpch_preprocess = 737,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 738,                     /* -fpeel-loops */
  OPT_fpeephole = 739,                       /* -fpeephole */
  OPT_fpeephole2 = 740,                      /* -fpeephole2 */
  OPT_fpermissive = 741,                     /* -fpermissive */
  OPT_fpic = 742,                            /* -fpic */
  OPT_fpie = 743,                            /* -fpie */
  OPT_fplan9_extensions = 744,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 745,                    /* -fplugin-arg- */
  OPT_fplugin_ = 746,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 747,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 748,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 749,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 750,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 751,                   /* -fpreprocessed */
  OPT_fpretty_templates = 752,               /* -fpretty-templates */
  OPT_fprofile = 753,                        /* -fprofile */
  OPT_fprofile_arcs = 754,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 755,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 756,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 757,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 758,              /* -fprofile-generate= */
  OPT_fprofile_use = 759,                    /* -fprofile-use */
  OPT_fprofile_use_ = 760,                   /* -fprofile-use= */
  OPT_fprofile_values = 761,                 /* -fprofile-values */
  OPT_fpromote_loop_indices = 762,           /* -fpromote-loop-indices */
  OPT_fprotect_parens = 763,                 /* -fprotect-parens */
  OPT_frandom_seed = 764,                    /* -frandom-seed */
  OPT_frandom_seed_ = 765,                   /* -frandom-seed= */
  OPT_frange_check = 766,                    /* -frange-check */
  OPT_freal_4_real_10 = 767,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 768,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 769,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 770,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 771,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 772,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 773,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 774,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 775,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 776,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 777,                /* -frecord-marker=8 */
  OPT_frecursive = 778,                      /* -frecursive */
  OPT_freduced_reflection = 779,             /* -freduced-reflection */
  OPT_free = 780,                            /* -free */
  OPT_freg_struct_return = 781,              /* -freg-struct-return */
  OPT_fregmove = 782,                        /* -fregmove */
  OPT_fremove_local_statics = 783,           /* -fremove-local-statics */
  OPT_frename_registers = 784,               /* -frename-registers */
  OPT_freorder_blocks = 785,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 786,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 787,              /* -freorder-functions */
  OPT_frepack_arrays = 788,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 789,           /* -freplace-objc-classes */
  OPT_frepo = 790,                           /* -frepo */
  OPT_frequire_return_statement = 791,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 792,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 793, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 794,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 795,                    /* -fresolution= */
  OPT_frounding_math = 796,                  /* -frounding-math */
  OPT_frtti = 797,                           /* -frtti */
  OPT_fsaw_java_file = 798,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 799,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 800,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 801,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 802,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 803,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 804,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 805,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 806,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 807,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 808,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 809,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 810,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 811,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 812,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 813,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 814,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 815,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 816, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 817,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 818,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 819,              /* -fsecond-underscore */
  OPT_fsection_anchors = 820,                /* -fsection-anchors */
  /* OPT_fsee = 821, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 822,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 823,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 824, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 825,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 826,          /* -fselective-scheduling2 */
  OPT_fshort_double = 827,                   /* -fshort-double */
  OPT_fshort_enums = 828,                    /* -fshort-enums */
  OPT_fshort_wchar = 829,                    /* -fshort-wchar */
  OPT_fshow_column = 830,                    /* -fshow-column */
  OPT_fshrink_wrap = 831,                    /* -fshrink-wrap */
  OPT_fsign_zero = 832,                      /* -fsign-zero */
  OPT_fsignaling_nans = 833,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 834,               /* -fsigned-bitfields */
  OPT_fsigned_char = 835,                    /* -fsigned-char */
  OPT_fsigned_zeros = 836,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 837,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 838,               /* -fsource-filename= */
  OPT_fsource_ = 839,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 840,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 841,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 842,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 843, */                 /* -fsquangle */
  OPT_fstack_arrays = 844,                   /* -fstack-arrays */
  /* OPT_fstack_check = 845, */              /* -fstack-check */
  OPT_fstack_check_ = 846,                   /* -fstack-check= */
  OPT_fstack_limit = 847,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 848,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 849,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 850,                /* -fstack-protector */
  OPT_fstack_protector_all = 851,            /* -fstack-protector-all */
  OPT_fstack_usage = 852,                    /* -fstack-usage */
  OPT_fstats = 853,                          /* -fstats */
  OPT_fstore_check = 854,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 855, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 856,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 857,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 858,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 859, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 860,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 861,                    /* -fsyntax-only */
  OPT_ftabstop_ = 862,                       /* -ftabstop= */
  /* OPT_ftarget_help = 863, */              /* -ftarget-help */
  OPT_ftarget_ = 864,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 865, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 866,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 867,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 868, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 869,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 870,             /* -fthreadsafe-statics */
  OPT_ftime_report = 871,                    /* -ftime-report */
  OPT_ftls_model_ = 872,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 873,               /* -ftoplevel-reorder */
  OPT_ftracer = 874,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 875,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 876,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 877,                  /* -ftrapping-math */
  OPT_ftrapv = 878,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 879,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 880,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 881,                       /* -ftree-ccp */
  OPT_ftree_ch = 882,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 883,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 884,                /* -ftree-copyrename */
  OPT_ftree_cselim = 885,                    /* -ftree-cselim */
  OPT_ftree_dce = 886,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 887,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 888,                       /* -ftree-dse */
  OPT_ftree_forwprop = 889,                  /* -ftree-forwprop */
  OPT_ftree_fre = 890,                       /* -ftree-fre */
  OPT_ftree_if_to_switch_conversion = 891,   /* -ftree-if-to-switch-conversion */
  OPT_ftree_loop_distribute_patterns = 892,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 893,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 894,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 895,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 896,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 897,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 898, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 899,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 900,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 901,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 902,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 903,                   /* -ftree-phiprop */
  OPT_ftree_pre = 904,                       /* -ftree-pre */
  OPT_ftree_pta = 905,                       /* -ftree-pta */
  OPT_ftree_reassoc = 906,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 907, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 908,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 909,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 910,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 911,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 912, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 913, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 914,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 915,                /* -ftree-tail-merge */
  ...
  OPT_fuse_caller_save = 933,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 934,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 935,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 936,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 937,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 938,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 939,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 940,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 941,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 942, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 943,                /* -fvect-cost-model */
  OPT_fverbose_asm = 944,                    /* -fverbose-asm */
  /* OPT_fversion = 945, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 946,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 947,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 948,                    /* -fvisibility= */
  OPT_fvpt = 949,                            /* -fvpt */
  /* OPT_fvtable_gc = 950, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 951, */            /* -fvtable-thunks */
  OPT_fweak = 952,                           /* -fweak */
  OPT_fweb = 953,                            /* -fweb */
  OPT_fwhole_file = 954,                     /* -fwhole-file */
  OPT_fwhole_program = 955,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 956,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 957,              /* -fworking-directory */
  OPT_fwpa = 958,                            /* -fwpa */
  OPT_fwrapv = 959,                          /* -fwrapv */
  /* OPT_fxref = 960, */                     /* -fxref */
  /* OPT_fzee = 961, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 962,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 963,                      /* -fzero-link */
  OPT_g = 964,                               /* -g */
  OPT_gant = 965,                            /* -gant */
  OPT_gcoff = 966,                           /* -gcoff */
  OPT_gdwarf_ = 967,                         /* -gdwarf- */
  OPT_gen_decls = 968,                       /* -gen-decls */
  OPT_ggdb = 969,                            /* -ggdb */
  OPT_gnat = 970,                            /* -gnat */
  OPT_gnatO = 971,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 972,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 973,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 974,            /* -grecord-gcc-switches */
  OPT_gstabs = 975,                          /* -gstabs */
  OPT_gstabs_ = 976,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 977,                   /* -gstrict-dwarf */
  OPT_gtoggle = 978,                         /* -gtoggle */
  OPT_gvms = 979,                            /* -gvms */
  OPT_gxcoff = 980,                          /* -gxcoff */
  OPT_gxcoff_ = 981,                         /* -gxcoff+ */
  OPT_h = 982,                               /* -h */
  OPT_idirafter = 983,                       /* -idirafter */
  OPT_imacros = 984,                         /* -imacros */
  OPT_imultiarch = 985,                      /* -imultiarch */
  ...
  OPT_mabi_ = 998,                           /* -mabi= */
  OPT_mabort_on_noreturn = 999,              /* -mabort-on-noreturn */
  OPT_mapcs = 1000,                          /* -mapcs */
  OPT_mapcs_float = 1001,                    /* -mapcs-float */
  OPT_mapcs_frame = 1002,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1003,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1004,              /* -mapcs-stack-check */
  OPT_march_ = 1005,                         /* -march= */
  OPT_marm = 1006,                           /* -marm */
  OPT_mbig_endian = 1007,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1008,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1009,     /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 1010,      /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 1011,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1012,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1013,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1014,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1015, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1016, */                    /* -mfp=3 */
  OPT_mfpe = 1017,                           /* -mfpe */
  /* OPT_mfpe_2 = 1018, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1019, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1020,                          /* -mfpu= */
  /* OPT_mhard_float = 1021, */              /* -mhard-float */
  OPT_mlittle_endian = 1022,                 /* -mlittle-endian */
  OPT_mlong_calls = 1023,                    /* -mlong-calls */
  OPT_mpic_register_ = 1024,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1025,            /* -mpoke-function-name */
  OPT_msched_prolog = 1026,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1027,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1028, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1029,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1030,                         /* -mthumb */
  OPT_mthumb_interwork = 1031,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1032,                  /* -mtls-dialect= */
  OPT_mtp_ = 1033,                           /* -mtp= */
  OPT_mtpcs_frame = 1034,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1035,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1036,                         /* -mtune= */
  OPT_munaligned_access = 1037,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1038,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1039,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1040,              /* -mword-relocations */
  OPT_mwords_little_endian = 1041,           /* -mwords-little-endian */
  OPT_n = 1042,                              /* -n */
  OPT_no_canonical_prefixes = 1043,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1044,              /* -no-integrated-cpp */
  OPT_nocpp = 1045,                          /* -nocpp */
  OPT_nodefaultlibs = 1046,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1047,                   /* -nostartfiles */
  OPT_nostdinc = 1048,                       /* -nostdinc */
  OPT_nostdinc__ = 1049,                     /* -nostdinc++ */
  OPT_nostdlib = 1050,                       /* -nostdlib */
  OPT_o = 1051,                              /* -o */
  OPT_p = 1052,                              /* -p */
  OPT_pass_exit_codes = 1053,                /* -pass-exit-codes */
  OPT_pedantic = 1054,                       /* -pedantic */
  OPT_pedantic_errors = 1055,                /* -pedantic-errors */
  OPT_pg = 1056,                             /* -pg */
  OPT_pie = 1057,                            /* -pie */
  OPT_pipe = 1058,                           /* -pipe */
  OPT_print_file_name_ = 1059,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1060,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1061,          /* -print-multi-directory */
  OPT_print_multi_lib = 1062,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1063,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1064,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1065,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1066,               /* -print-prog-name= */
  OPT_print_search_dirs = 1067,              /* -print-search-dirs */
  OPT_print_sysroot = 1068,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1069,   /* -print-sysroot-headers-suffix */
  ...
  OPT_time = 1120,                           /* -time */
  OPT_time_ = 1121,                          /* -time= */
  OPT_traditional = 1122,                    /* -traditional */
  OPT_traditional_cpp = 1123,                /* -traditional-cpp */
  OPT_trigraphs = 1124,                      /* -trigraphs */
  OPT_u = 1125,                              /* -u */
  OPT_undef = 1126,                          /* -undef */
  OPT_v = 1127,                              /* -v */
  OPT_version = 1128,                        /* -version */
  OPT_w = 1129,                              /* -w */
  OPT_wrapper = 1130,                        /* -wrapper */
  OPT_x = 1131,                              /* -x */
  OPT_z = 1132,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
